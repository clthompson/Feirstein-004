...
<script type="text/javascript">
  ...
  <body class="fadeIn">
	...
	Activity name of this tag: Screen Writing_Dec
	URL of the webpage where the tag is expected to be placed: http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/mfa-screenwriting.php
	This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
	Creation Date: 12/04/2014 -->
		<script type="text/javascript">
		var axel = Math.random() + "";
		var a = axel * 10000000000000;
		document.write('<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=scree0;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
		</script>
		<noscript>
		<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=scree0;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
		</noscript>
...
<div class="mobile-menu">
	...
	<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/mfa-screenwriting.php" class="screenwriting active">
		<div class="icon"></div>
...
<section class="academics-hero">
	<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-screenwriting-hero.jpg">
</section>
<section class="academics-info ma-screenwriting">
	<div class="course">
		<div class="course-title">
			<div class="icon">
				<div class="circle">
					<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-icons/white_screenwriting.png">
				</div>
			</div>
			<div class="text">
	...
	<div class="degree">
		...
		<ul>
			<li>Advanced Screenwriting 1</li>
