...
<head>
	...
	<title>Barry R. Feirstein Graduate School of Cinema - Producing</title>
	...
	<!-- meta -->
	<!-- Google Meta -->
	<meta itemprop="name" content="Barry R. Feirstein Graduate School of Cinema - Producing">
...
<script type="text/javascript">
  ...
  <body class="fadeIn">
	...
	Activity name of this tag: Product_Dec
	URL of the webpage where the tag is expected to be placed: http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/mfa-producing.php
	This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
	Creation Date: 12/04/2014 -->
		<script type="text/javascript">
		var axel = Math.random() + "";
		var a = axel * 10000000000000;
		document.write('<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=produ0;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
		</script>
		<noscript>
...
<div class="mobile-menu">
	...
	<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/mfa-producing.php" class="producing active">
		<div class="icon"></div>
		<span>Producing</span>
	</a>
...
<section class="academics-hero">
	<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-producing-hero.jpg">
</section>
<section class="academics-info ma-producing">
	<div class="course">
		<div class="course-title">
			<div class="icon">
				<div class="circle">
					<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-icons/white_producing.png">
				</div>
			</div>
			<div class="text">
				<h4 class="smaller">Producing</h4>
			</div>
		</div>
	...
	<div class="degree">
		...
		<ul>
			<li>Finance for Film and Other Media</li>
