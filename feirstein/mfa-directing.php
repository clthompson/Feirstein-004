...
<head>
	...
	<title>Barry R. Feirstein Graduate School of Cinema - Directing</title>
	...
	<!-- meta -->
	<!-- Google Meta -->
	<meta itemprop="name" content="Barry R. Feirstein Graduate School of Cinema - Directing">
...
<script type="text/javascript">
  ...
  <body class="fadeIn">
	...
	Activity name of this tag: Directing_Dec
	URL of the webpage where the tag is expected to be placed: http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/mfa-directing.php
	This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
	Creation Date: 12/04/2014 -->
		<script type="text/javascript">
		var axel = Math.random() + "";
		var a = axel * 10000000000000;
		document.write('<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=direc0;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
		</script>
		<noscript>
		<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=direc0;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
		</noscript>
...
<div class="mobile-menu">
	...
	<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/mfa-directing.php" class="directing active">
		<div class="icon"></div>
		<span>Directing</span>
	</a>
...
<section class="academics-hero">
	<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-directing-hero.jpg">
</section>
<section class="academics-info ma-directing">
	<div class="course">
		<div class="course-title">
			<div class="icon">
				<div class="circle">
					<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-icons/white_directing.png">
				</div>
			</div>
			<div class="text">
	...
	<div class="degree">
		...
		<ul>
			<li>Directing the Camera</li>
			<li>Directing Workshop</li>
		...
		<ul>
			<li>Advanced Directing Workshop</li>
			<li>Cinematography 1</li>
			<li>Production Workshop 4</li>
		...
		<ul>
			...
			<li>Film Genres</li>
			<li>Global Cinema</li>
			<li>History and Theory of Documentary Film</li>
			<li>Industry Internship</li>
			<li>Introduction to Computer Animation</li>
			<li>Introduction to Entertainment Law</li>
			<li>Introduction to Visual Effects</li>
