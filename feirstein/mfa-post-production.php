...
<script type="text/javascript">
  ...
  <body class="fadeIn">
	...
	Activity name of this tag: Post Prod_ Dec
	URL of the webpage where the tag is expected to be placed: http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/mfa-post-production.php
	This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
	Creation Date: 12/04/2014 -->
		<script type="text/javascript">
		var axel = Math.random() + "";
		var a = axel * 10000000000000;
		document.write('<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=postp0;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
		</script>
		<noscript>
		<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=postp0;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
		</noscript>
...
<div class="mobile-menu">
	...
	<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/mfa-post-production.php" class="post-production active">
		<div class="icon"></div>
...
<section class="academics-hero">
	<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-post-production-hero.jpg">
</section>
<section class="academics-info ma-post-production">
	<div class="course">
		<div class="course-title">
			<div class="icon">
				<div class="circle">
					<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-icons/white_post-production.png">
				</div>
			</div>
			<div class="text">
