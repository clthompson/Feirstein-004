...
<head>
	...
	<title>Barry R. Feirstein Graduate School of Cinema - Advisory Council</title>
	...
	<!-- meta -->
	<!-- Google Meta -->
	<meta itemprop="name" content="Barry R. Feirstein Graduate School of Cinema - Advisory Council">
	...
	<div class="content">
		<div class="wrap">
			...
			<article class="hidden" data-person="barry-r-feirstein">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Barry_Feirstein.jpg')">
				</div>
				<div class="bio">
			...
			<article class="hidden" data-person="darren-aronofsky">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Darren_Aronofsky.jpg')">
				</div>
				<div class="bio">
					<h5>Darren Aronofsky</h5>
					<p>Academy Award–nominated director Darren Aronofsky was born and raised in Brooklyn, N.Y.</p>
					<p>His most recent film, <em>Noah</em> (2014), starred Russell Crowe, Jennifer Connelly, Emma Watson and Anthony Hopkins. It was hailed by Richard Roeper as "one of the most dazzling and unforgettable Biblical epics ever put on film."</p>
					<p>In 2011, Aronofsky directed <em>Black Swan</em>, which earned Natalie Portman an Academy Award for Best Actress and Aronofsky a nomination for Best Director. In 2008, he directed <em>The Wrestler</em>, recipient of the Golden Lion at the Venice Film Festival. Mickey Rourke and Marisa Tomei received Academy Award nominations for their performances; Rourke won a Golden Globe for Best Actor — Drama, and Bruce Springsteen won for Best Original Song. Aronofsky also directed <em>The Fountain</em> (2006), starring Hugh Jackman and Rachel Weisz, and <em>Requiem for a Dream</em> (2000), starring Jared Leto, Ellen Burstyn and Jennifer Connolly. His first feature, <em>π</em> (1998), won the Director's Award at Sundance Film Festival.</p>
					<p>Aronofsky is a graduate of Harvard University and the American Film Institute.</p>
				</div>
			</article>
			<article class="hidden" data-person="don-buchwald">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Don_Buchwald.jpg')">
				</div>
				<div class="bio">
					<h5>Don Buchwald</h5>
					<p>Don Buchwald is the founder of Don Buchwald & Associates, a full-service talent and literary agency with offices in New York and Los Angeles, whose roster of clientele includes actors, directors, producers, writers and broadcasters, most notably Howard Stern.</p>
			...
			<article class="hidden" data-person="celia-costas">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Celia_Costas.jpg')">
				</div>
				<div class="bio">
					<h5>Celia Costas</h5>
			...
			<article class="hidden" data-person="roy-furman">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Roy_Furman.jpg')">
				</div>
				<div class="bio">
					<h5>Roy Furman</h5>
			...
			<article class="hidden" data-person="ethan-hawke">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Ethan_Hawke.jpg')">
				</div>
				<div class="bio">
					<h5>Ethan Hawke</h5>
			...
			<article class="hidden" data-person="steven-soderbergh">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Steven_Soderbergh.jpg')">
				</div>
				<div class="bio">
			...
			<article class="hidden" data-person="douglas-steiner">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Douglas_Steiner.jpg')">
				</div>
				<div class="bio">
					<h5>Douglas C. Steiner</h5>
			...
			<article class="hidden" data-person="fisher-stevens">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Fisher_Stevens.jpg')">
				</div>
				<div class="bio">
			...
			<article class="hidden" data-person="joana-vicente">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Joana_Vicente.jpg')">
				</div>
				<div class="bio">
					<h5>Joana Vicente</h5>
			...
			<article data-person="jonathan-wacks">
				<div class="picture" style="background-image:url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Jonathan_Wacks_Council.jpg')">
				</div>
				<div class="bio">
