...
<head>
	...
	<title>Barry R. Feirstein Graduate School of Cinema - Contact Us</title>
...
<script type="text/javascript">
  ...
  <body class="fadeIn">
	...
	Activity name of this tag: Contact Page_Dec
	URL of the webpage where the tag is expected to be placed: http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/contact-us.php
	This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
	Creation Date: 12/04/2014 -->
		<script type="text/javascript">
		var axel = Math.random() + "";
		var a = axel * 10000000000000;
		document.write('<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=conta0;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
		</script>
		<noscript>
		<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=conta0;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
		</noscript>
	...
	<nav>
		<div class="menu">
			...
			<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/contact-us.php" class="menu-item active"><span>Contact</span></a>
		</div>
	</nav>
	<div class="gutter"></div>
</header>
<div class="mobile-menu">
	...
	<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/contact-us.php" class="menu-item"><span>Contact</span></a>
		...
		<section class="contact-info" style="background-image: url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/contact_hero.jpg')">
	<div class="overlay">
...
<section class="split-overlay contact-form" style="overflow: hidden;">
	<div class="overlay">
		...
		<form class="general-form" action="http://cuny.us1.list-manage.com/subscribe/post-json" method="POST">
			...
			<TEXTAREA class="comment" placeholder="Comment" rows="6"></TEXTAREA>
			<button type="submit" class="submit" value="Submit">
				<div class="content"><h6>Submit</h6></div>
				<div class="cta-info"><div class="content"><h6>Submit</h6>
				</div></div>
			</button>
		</form>
	</div>
...
<script>window.App.contact.run()</script>
