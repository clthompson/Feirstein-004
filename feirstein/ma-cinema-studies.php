...
<script type="text/javascript">
  ...
  <body class="fadeIn">
	...
	Activity name of this tag: Cinema_Dec
	URL of the webpage where the tag is expected to be placed: http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/ma-cinema-studies.php
	This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
	Creation Date: 12/04/2014 -->
		<script type="text/javascript">
		var axel = Math.random() + "";
		var a = axel * 10000000000000;
		document.write('<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=cinem0;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
		</script>
		<noscript>
		<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=cinem0;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
		</noscript>
...
<div class="mobile-menu">
	...
	<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/ma-cinema-studies.php" class="cinema-studies active">
		<div class="icon"></div>
...
<section class="academics-hero">
	<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-cinema-studies-hero.jpg">
</section>
<section class="academics-info ma-cinema-studies">
	<div class="course">
		<div class="course-title">
			<div class="icon">
				<div class="circle">
					<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/academics-icons/white_cinema-studies.png">
				</div>
			</div>
			<div class="text">
