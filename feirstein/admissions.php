...
<!-- end Mixpanel -->
  ...
  <body class="fadeIn">
	...
	<nav>
		<div class="menu">
			<a href="http://www.brooklyn.cuny.edu/web/feirsteinbeta/feirstein/admissions.php" class="menu-item active"><span >Admissions</span></a>
...
<div class="mobile-menu">
	...
	<a href="http://www.brooklyn.cuny.edu/web/feirsteinbeta/feirstein/contact-us.php" class="menu-item"><span>Contact</span></a>
		...
		<section class="internal-page-hero" style="background-image: url('http://www.brooklyn.cuny.edu/web/feirsteinbeta/feirstein/build/images/Admissions_top_image.png'); background-position: bottom">
	<div class="overlay">
		<div class="page-title salmon">
			<h3 class="fit">ADMISSIONS</h3>
...
<section class="admission-image-headline" style="background-image: url('http://www.brooklyn.cuny.edu/web/feirsteinbeta/feirstein/build/images/Admissions_img2.jpg')">
	<div class="right-align">
		<div class="apply-drop" style="background-image: url('http://www.brooklyn.cuny.edu/web/feirsteinbeta/feirstein/build/images/yellow-box.jpg')">
			<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/feirsteingraduateapplication.php" class="cta warm" target="_blank">
	...
	<div class="three-wrap">
		...
		<div class="item">
			<div class="button international">
				<img src="http://www.brooklyn.cuny.edu/web/feirsteinbeta/feirstein/build/images/admissions-icons/int_students.png" alt="International Students">
			</div>
			<p>International Students</p>
		</div>
		<div class="item">
			<div class="button financial">	
				<img src="http://www.brooklyn.cuny.edu/web/feirsteinbeta/feirstein/build/images/admissions-icons/tuition.png" alt="Tuition and Financial aid">
			</div>
			<p>Tuition & Fees</p>
		</div>
	</div>
</section>
<section class="right-bar-container admissions-info">
		...
		<div class="admission-info">
			<div class="split-item  adm-requirements">
				...
				<article id="admissions-ma-cinemastudies">
					<h5>Admissions Guidelines for M.A. in Cinema Studies</h5>
					<p>The Feirstein Graduate School of Cinema is committed to providing a comprehensive education in cinema history, theory, criticism and aesthetics, and to encourage the scholarly exploration of motion pictures as a form of art and a means of social communication. Students are required to complete a total of 36 credits, which may be pursued on either a full-time basis in two years or on a part-time basis. Because the degree program will be housed in the same facility as the proposed M.F.A. in Cinema Arts program (the Steiner Studios at the Brooklyn Navy Yard), students will be able to deepen their knowledge within the context of a larger community of filmmakers and cinema scholars. The program’s interrelationship with the M.F.A. program will make it truly unique.</p>
					<p>The Office of Graduate Admissions manages applications to the M.A. in Cinema Studies. Only complete applications are forwarded to the Feirstein Graduate School of Cinema.</p>
					...
					<p>Write a three- to four-page (double-spaced 12-point font) statement explaining your purpose in undertaking graduate study in cinema arts. This is your opportunity to articulate your goals, interests and career plans as they relate to undertaking an M.F.A. in cinema arts. We are trying to gain a sense of who you are and the distinctive experiences and interests that have motivated you to pursue this degree.</p>
					<strong>Résumé/CV</strong>
					<p>Submit a copy of your résumé or CV, including your education to date, employment and other relevant information.</p>
					<strong>GRE</strong>
					<p>The <a href="http://www.ets.org/gre" target="_blank">Graduate Record Examination</a> (GRE) is not required.</p>
					<h5>Writing sample</h5>
					...
					<h5>Deadlines</h5>
					<p>Applications open on November 1, 2014. Deadline for priority admissions is December 1, 2014. Applications received after the deadline will be reviewed on a rolling admissions basis until the class is full.</p>
				</article>
				<div id="mfa-cinemaarts"></div>
				<aside><h3>MFA</h3><h5>in cinema <br/>arts</h5></aside>
				<article>
					<h5>Admissions Guidelines for M.F.A. in Cinema Arts</h5>
					<p>Applications to the M.F.A. in Cinema Arts program will be considered based on demonstrated evidence of the following:</p>
					<ul>
						<li>Undergraduate record of achievement with a minimum grade point average of 3.00</li>
						<li>An abiding commitment to the art of filmmaking</li>
						<li>A clear intention to pursue a career in the moving image arts</li>
					...
					<p>Students are accepted into only one filmmaking discipline: producing, directing, screenwriting, cinematography or post-production. Although classes are required across the different disciplines, once accepted, you will not be able to transfer into another discipline. You may, however, apply to up to two disciplines, indicating your first-choice discipline. Students are admitted on a full-time basis only and required to complete a total of 66 credits over three years.</p>
					...
					2. In 10 pages or less, (double-spaced 12-point font) write a treatment for a feature film that you would like to produce, including one page explaining why.</p>
					...
					2. In 10 pages or less, (double-spaced 12-point font) write a treatment for a feature film that you would like to direct, including one page explaining why.</p>
					...
					2. In 10 pages or less (double-spaced 12-point font) write a treatment for a feature film that you would like to write, including one page explaining why.</p>
					...
					<p>Register and <a href="http://feirsteincinema.slideroom.com" target="_blank">set up an account on Slideroom</a>. Once you have registered to start a portfolio via Slideroom, you may step away and come back at any time, until the final deadline. Please ensure that you save your progress after each visit, and do not click to submit until you are certain that you have uploaded the required components. Once you click submit, you may no longer edit your portfolio. Once you submit your portfolio, Slideroom will send you an e-mail to confirm receipt of your materials.</p>
					<p>The submission of video can contain one or more selections as long as the total running time does not exceed 30 minutes. You may upload up to 10 minutes of video on to the media page within Slideroom. If the total running time of your video sample exceeds 10 minutes, a link to your work must be provided on the media page. Please test your video prior to submission. If you are submitting a link, please be sure no downloads or passwords are required. For technical assistance, please <a href="mailto:support@slideroom.com" target="_blank">e-mail Slideroom</a>.</p>
					<h5>DEADLINES</h5>
					<p>Applications open on November 1, 2014. Deadline for priority admissions is December 1, 2014. Applications received after the deadline will be reviewed on a rolling admissions basis until the class is full. Each track is capped at 14 students, except for screenwriting, where up to 20 students will be admitted.</p>
				</article>
			</div>
			<div class="split-item  international-students hidden">
				<div class="breadcrumbs"></div>
				<aside><h5>International<br>students</h5></aside>
				<article>
					<h5>International Students</h5>
					<p>The Feirstein Graduate School of Cinema encourages international students to apply for admission to both the M.A. and M.F.A. degree programs. The application process (including portfolio) is the same as for all other students, with these additional requirements:</p>
					<strong>International Transcript Credential Evaluation</strong>
					<p>International transcripts must be evaluated by a professional agency that is a member of the <a href="http://www.naces.org/" target="_blank" class="bordeaux">National Association of Credential Evaluation Services</a>. Evaluations must include a course-by-course analysis indicating the type of degree received, the U.S. equivalency of the degree, the graduation date and a cumulative grade point average.</p>
					<strong>Test Of English As A Foreign Language (TOEFL)</strong>
					<p>A <a href="http://www.ets.org/toefl" target="_blank" class="bordeaux">TOEFL</a> score report is required from applicants whose first language is not English and who did not receive the equivalent of a four-year U.S. undergraduate education from an institution where English is the official language of instruction. We only accept TOEFL scores sent to us directly from Educational Testing Services (ETS). Our ETS Institution code is 2046. The minimum IBT score required for consideration is 100. We also accept the IELTS exam with score of 7.0 or higher.</p>
					<strong>Financial Aid</strong>
					<p>The Office of Financial Aid offers a variety of federal and state financial aid options designed to assist graduate students in financing their college education. Please follow <a href="http://www.brooklyn.cuny.edu/web/about/administration/enrollment/financial/graduate.php" target="_blank" class="bordeaux">this link</a>.</p>
				</article>
			</div>
