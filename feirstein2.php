...
<head>
	...
	<title>Barry R. Feirstein Graduate School of Cinema</title>
...
<!-- end Mixpanel -->
  ...
  <body class="fadeIn">
	...
	Activity name of this tag: Landing Page_Dec
	URL of the webpage where the tag is expected to be placed: http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein.php
	This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
	Creation Date: 12/04/2014 -->
		<script type="text/javascript">
		var axel = Math.random() + "";
		var a = axel * 10000000000000;
		document.write('<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=landi0;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
		</script>
		<noscript>
		<iframe src="http://4535897.fls.doubleclick.net/activityi;src=4535897;type=Fall20;cat=landi0;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
		</noscript>
...
<section class="image-headline" style="background-image: url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Home_2.jpg')">
	<div class="overlay wrapz">
		<h2 class="left">Film school</h2>
		<h3 class="yellow">on a film lot</h3>
		<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/divider-warm-long.png" class="divider">
	</div>
</section>
	<section class="facilities-cta">
		<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/facilities.php" class="cta dark">
			<div class="content"><h6>Facilities</h6></div>
			<div class="cta-info"><div class="content"><h6>Facilities</h6></div></div>
		</a>
	</section>
<section class="image-headline align-left" style="background-image: url('http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/Home_3.jpg')">
	<div class="overlay thewrap">
		<div class="opa">
			<h3>Learn from leading professionals</h3>
			<h4>in the film industry</h4>
			<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/divider-cold-long.png" class="divider">
		</div>
		<a href="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/academics.php" class="cta cold">
			<div class="content"><h6>Degrees</h6></div>
			<div class="cta-info"><div class="content"><h6>Degrees</h6></div></div>
		</a>
	</div>
</section>
<section class="split-overlay bike">
	<div class="overlay">
		<div class="content thewrap">
			<h3 class="yellow view">Brooklyn</h3>
	...
	<img src="http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/build/images/divider-cold-short.png" class="divider">
</section>
<section class="social-media-boxes" id="instafeed">
...
<footer>
	...
	<script src="http://match.rundsp.com/redirect-all.js?seg=aHY"></script>
